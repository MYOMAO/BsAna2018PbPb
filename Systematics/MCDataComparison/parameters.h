...
const int NBins = 1;
const double ptBins[NBins+1]={7,100};
...
double Binning[NVar] ={Npt,Nalpha,NProb,NRatio,NBy,NBDTG,NBDTG,NBDTG,NBtrk1D0,NBtrk2D0,NBtrk1D0Err,NBtrk2D0Err,NBtrk1Pt,NBtrk2Pt,NBmu1Eta,NBmu2Eta,NBmu1Pt,NBmu2Pt,NBmass,NBtrk1Eta,NBtrk2Eta,NBtrk1Dz,NBtrk2Dz};
double Min[NVar]	= {ptmin,alphamin,Probmin,Ratiomin,Bymin,BDTGMin,BDTGMin,BDTGMin,Btrk1D0Min,Btrk2D0Min,Btrk1D0ErrMin,Btrk2D0ErrMin,Btrk1PtMin,Btrk2PtMin,Bmu1EtaMin,Bmu2EtaMin,Bmu1PtMin,Bmu2PtMin,BMassMin,Btrk1EtaMin,Btrk2EtaMin,Btrk1DzMin,Btrk2DzMin};
...
double Max[NVar]	= {ptmax,alphamax,Probmax,Ratiomax,Bymax,BDTGMax,BDTGMax,BDTGMax,Btrk1D0Max,Btrk2D0Max,Btrk1D0ErrMax,Btrk2D0ErrMax,Btrk1PtMax,Btrk2PtMax,Bmu1EtaMax,Bmu2EtaMax,Bmu1PtMax,Bmu2PtMax,BMassMax,Btrk1EtaMax,Btrk2EtaMax,Btrk1DzMax,Btrk2DzMax};
...
double MaxY[NVar] ={0.80,0.25,0.20,0.30,0.20,0.30,0.15,0.15,0.15,0.15,0.15,0.15,0.15,0.15,0.15,0.15,0.15,0.15,0.15,0.15,0.15,0.15,0.15};

TString VarSData[NVar] = {"pthisSData","alphahisSData","ProbhisSData","RatiohisSData","ByhisSData","BDT7-15hisSData","BDT15-20hisSData","BDT20-50hisSData","Btrk1D0hisSData","Btrk2D0hisSData","Btrk1D0ErrhisSData","Btrk2D0ErrhisSData","Btrk1PthisSData","Btrk2PthisSData","Bmu1EtahisSData","Bmu2EtahisSData","Bmu1PthisSData","Bmu2PthisSData","BmassSData","Btrk1EtaSData","Btrk2EtaSData","Btrk1DzSData","Btrk2DzSData"};  

TString VarBData[NVar] = {"pthisBData","alphahisBData","ProbhisBData","RatiohisBData","ByhisBData","BDT7-15hisBData","BDT15-20hisBData","BDT20-50hisBData","Btrk1D0hisBData","Btrk2D0hisBData","Btrk1D0ErrhisBData","Btrk2D0ErrhisBData","Btrk1PthisBData","Btrk2PthisBData","Bmu1EtahisBData","Bmu2EtahisBData","Bmu1PthisBData","Bmu2PthisBData","BmassBData","Btrk1EtaBData","Btrk2EtaBData","Btrk1DzBData","Btrk2DzBData"};  
...
TString Var[NVar] = {"Bpt","Balpha","Bchi2cl","BsvpvDistance/BsvpvDisErr","By","BDT_pt_7_15","BDT_pt_15_20","BDT_pt_20_50","Btrk1D0","Btrk2D0", "Btrk1D0Err", "Btrk2D0Err", "Btrk1Pt", "Btrk2Pt","Bmu1eta","Bmu2eta","Bmu1pt","Bmu2pt","Bmass","Btrk1Eta","Btrk2Eta","Btrk1Dz","Btrk2Dz"};  

TString Name[NVar] = {"Dpt","Dalpha","Dchi2cl","Ratio","By","BDT_7_15","BDT_15_20","BDT_20_50","Btrk1D0","Btrk2D0","Btrk1D0Err","Btrk2D0Err","Btrk1Pt","Btrk2Pt","Bmu1Eta","Bmu2Eta","Bmu1Pt","Bmu2Pt","Bmass","Btrk1Eta","Btrk2Eta","Btrk1Dz","Btrk2Dz"};  
TString XName[NVar] = {"Dpt (GeV/c)","Balpha","Bchi2cl","Ratio","By","BDT_7_15","BDT_15_20","BDT_20_50","Btrk1D0","Btrk2D0","Btrk1D0Err","Btrk2D0Err","Btrk1Pt","Btrk2Pt","Bmu1Eta","Bmu2Eta","Bmu1Pt","Bmu2Pt","Bmass (GeV/c)","Btrk1Eta","Btrk2Eta","Btrk1Dz","Btrk2Dz"};  
TString YName[NVar] = {"Normalized Counts","Normalized Counts","Normalized Counts","Normalized Counts","Normalized Counts","Normalized Counts","Normalized Counts","Normalized Counts","Normalized Counts","Normalized Counts","Normalized Counts","Normalized Counts","Normalized Counts","Normalized Counts","Normalized Counts","Normalized Counts","Normalized Counts","Normalized Counts","Normalized Counts","Normalized Counts","Normalized Counts","Normalized Counts","Normalized Counts"};  


TString HisName[NVar] = {"Normalized Bpt Distribution","Normalized Balpha Distribution","Normalized Vertex Probability Distribution","Normalized Decay Length Ratio Distribution","Normalized By Distribution","Normalized BDT_7_15 Distribution","Normalized BDT_15_20 Distribution","Normalized BDT_20_50 Distribution","Normalized Btrk1D0 Distribution","Normalized Btrk2D0 Distribution","Normalized Btrk1D0Err Distribution","Normalized Btrk2D0Err Distribution","Normalized Btrk1Pt Distribution","Normalized Btrk2Pt Distribution","Normalized Bmu1Eta Distribution","Normalized Bmu2Eta Distribution","Normalized Bmu1Pt Distribution","Normalized Bmu2Pt Distribution","Normalized D Invariant Mass Distribution","Normalized Btrk1Eta Distribution","Normalized Btrk2Eta Distribution","Normalized Btrk1Dz Distribution","Normalized Btrk2Dz Distribution"};  
