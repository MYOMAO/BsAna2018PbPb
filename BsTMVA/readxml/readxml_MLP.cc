#include "readxml_MLP.h"

void readxml_MLP(TString inputSname, TString inputBname, TString outputname,
		...
		Float_t lumi, Float_t raa=1.)
{
	...
	TH2F* hemptydis = new TH2F("hemptydis",Form(";%s;Probability",mvatype.Data()),200,-1.1,1.1,10,0.,hdisEffB->GetMaximum()*1.4);
	sethempty(hemptydis);
	...
	TH2F* hemptyeff = new TH2F("hemptyeff",Form(";%s;Efficiency",mvatype.Data()),200,-1.1,1.1,10,0.,1.4);
	sethempty(hemptyeff);
	...
	TH2F* hempty = new TH2F("hempty",Form(";%s;S/sqrt(S+B)",mvatype.Data()),200,-1.1,1.1,10,0.,maxsig*1.4);
	sethempty(hempty);
...
int main(int argc, char* argv[])
{
	if(argc==16)
	{
		readxml_MLP(argv[1], argv[2], argv[3], argv[4], argv[5], argv[6], argv[7], argv[8], argv[9], argv[10], argv[11], atof(argv[12]), atof(argv[13]), atof(argv[14]), atof(argv[15]));
		return 0;
	}
	if(argc==15)
	{
		readxml_MLP(argv[1], argv[2], argv[3], argv[4], argv[5], argv[6], argv[7], argv[8], argv[9], argv[10], argv[11], atof(argv[12]), atof(argv[13]), atof(argv[14]));
		return 0;
	}
	else
	{
