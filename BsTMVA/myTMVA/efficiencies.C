      ...
      while ((titkey = TMVAGlob::NextKey(nextTitle,"TDirectory"))) {
         ...
         while ((hkey2 = TMVAGlob::NextKey(nextKey,"TH1"))) {
            ...
            if (hname.Contains( hNameRef ) && hname.BeginsWith( "MVA_" )) {
               ...
               h->Draw("csame");
			                 hists.Add(h);
							   TString FOUTNAME = Form("/afs/cern.ch/user/s/szhaozho/Analysis/CMSSW_7_5_8_patch3/LowPtAnalysis/PerformanceTest/newTMVA/tmvaBntupleRunII/myTMVA/%sROC%d.root",MVA.Data(),m);
