...
//=========  (Fri Feb  1 04:15:18 2019) by ROOT version6.02/13
   ...
   fmass12->SetParameter(0,1.91062);
   fmass12->SetParError(0,0.2166307);
   fmass12->SetParLimits(0,0,0);
   fmass12->SetParameter(1,5.364285);
   fmass12->SetParError(1,0.001902044);
   fmass12->SetParLimits(1,0,0);
   fmass12->SetParameter(2,0.01292668);
   ...
   fmass12->SetParameter(7,0.7797326);
   fmass12->SetParError(7,0);
   fmass12->SetParLimits(7,0,0);
   fmass12->SetParameter(8,0.03861677);
   ...
   f13->SetParameter(0,1.91062);
   f13->SetParError(0,0.2166307);
   f13->SetParLimits(0,0,0);
   f13->SetParameter(1,5.364285);
   f13->SetParError(1,0.001902044);
   f13->SetParLimits(1,0,0);
   f13->SetParameter(2,0.01292668);
   f13->SetParError(2,0);
   f13->SetParLimits(2,0.01292668,0.01292668);
   f13->SetParameter(3,151.1297);
   f13->SetParError(3,9.288044);
   f13->SetParLimits(3,0,0);
   f13->SetParameter(4,-0.4021346);
   f13->SetParError(4,0.1641192);
   f13->SetParLimits(4,-0.7,-0.4);
   f13->SetParameter(5,-13.38156);
   f13->SetParError(5,0.8469364);
   f13->SetParLimits(5,0,0);
   f13->SetParameter(6,1.555048);
   f13->SetParError(6,0.102086);
   f13->SetParLimits(6,0,0);
   f13->SetParameter(7,0.7797326);
   f13->SetParError(7,0);
   f13->SetParLimits(7,0.7797326,0.7797326);
   f13->SetParameter(8,0.03861677);
   f13->SetParError(8,0);
   f13->SetParLimits(8,0.03861677,0.03861677);
   f13->Draw("same");
   ...
   f11->SetParameter(0,1.91062);
   f11->SetParError(0,0.2166307);
   f11->SetParLimits(0,0,0);
   f11->SetParameter(1,5.364285);
   f11->SetParError(1,0.001902044);
   f11->SetParLimits(1,0,0);
   f11->SetParameter(2,0.01292668);
   f11->SetParError(2,0);
   f11->SetParLimits(2,0.01292668,0.01292668);
   f11->SetParameter(3,151.1297);
   f11->SetParError(3,9.288044);
   f11->SetParLimits(3,0,0);
   f11->SetParameter(4,-0.4021346);
   f11->SetParError(4,0.1641192);
   f11->SetParLimits(4,-0.7,-0.4);
   f11->SetParameter(5,-13.38156);
   f11->SetParError(5,0.8469364);
   f11->SetParLimits(5,0,0);
   f11->SetParameter(6,1.555048);
   f11->SetParError(6,0.102086);
   f11->SetParLimits(6,0,0);
   f11->SetParameter(7,0.7797326);
   f11->SetParError(7,0);
   f11->SetParLimits(7,0.7797326,0.7797326);
   f11->SetParameter(8,0.03861677);
   f11->SetParError(8,0);
   f11->SetParLimits(8,0.03861677,0.03861677);
...
tex->SetNDC();
   ...
   f12->SetParameter(0,1.91062);
   f12->SetParError(0,0.2166307);
   f12->SetParLimits(0,0,0);
   f12->SetParameter(1,5.364285);
   f12->SetParError(1,0.001902044);
   f12->SetParLimits(1,0,0);
   f12->SetParameter(2,0.01292668);
   f12->SetParError(2,0);
   f12->SetParLimits(2,0.01292668,0.01292668);
   f12->SetParameter(3,151.1297);
   f12->SetParError(3,9.288044);
   f12->SetParLimits(3,0,0);
   f12->SetParameter(4,-0.4021346);
   f12->SetParError(4,0.1641192);
   f12->SetParLimits(4,-0.7,-0.4);
   f12->SetParameter(5,-13.38156);
   f12->SetParError(5,0.8469364);
   f12->SetParLimits(5,0,0);
   f12->SetParameter(6,1.555048);
   f12->SetParError(6,0.102086);
   f12->SetParLimits(6,0,0);
   f12->SetParameter(7,0.7797326);
   f12->SetParError(7,0);
   f12->SetParLimits(7,0.7797326,0.7797326);
   f12->SetParameter(8,0.03861677);
   f12->SetParError(8,0);
   f12->SetParLimits(8,0.03861677,0.03861677);
   f12->Draw("same");
   ...
   h13->Draw("e same");
      tex = new TLatex(0.55,0.5,"#chi^{2}/nDOF: 68/44 = 1.5");
tex->SetNDC();
   tex->SetTextAlign(12);
   tex->SetTextFont(42);
   ...
   tex->SetLineWidth(2);
   tex->Draw();
      tex = new TLatex(0.55,0.54,"Significance = 8.9");
tex->SetNDC();
   tex->SetTextFont(42);
   tex->SetTextSize(0.04);
   tex->SetLineWidth(2);
   tex->Draw();
      tex = new TLatex(0.55,0.44,"Yield = 96");
tex->SetNDC();
   tex->SetTextFont(42);
   tex->SetTextSize(0.04);
   tex->SetLineWidth(2);
