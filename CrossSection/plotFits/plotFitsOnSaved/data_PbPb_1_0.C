...
//=========  (Fri Feb  1 04:27:44 2019) by ROOT version6.02/13
   ...
   c1->Range(4.76834,-6.524303,6.055341,38.47089);
   c1->SetFillColor(0);
   c1->SetBorderMode(0);
   c1->SetBorderSize(2);
   ...
   h11->SetBinContent(0,114);
   h11->SetBinContent(1,7);
   h11->SetBinContent(3,1);
   h11->SetBinContent(4,2);
   h11->SetBinContent(5,4);
   h11->SetBinContent(6,7);
   h11->SetBinContent(8,3);
   h11->SetBinContent(9,1);
   h11->SetBinContent(10,1);
   h11->SetBinContent(11,2);
   h11->SetBinContent(12,1);
   h11->SetBinContent(14,1);
   h11->SetBinContent(15,1);
   h11->SetBinContent(16,3);
   h11->SetBinContent(17,2);
   h11->SetBinContent(18,3);
   h11->SetBinContent(19,15);
   h11->SetBinContent(20,4);
   h11->SetBinContent(21,4);
   h11->SetBinContent(22,2);
   h11->SetBinContent(23,4);
   h11->SetBinContent(24,1);
   h11->SetBinContent(25,1);
   h11->SetBinContent(26,2);
   h11->SetBinContent(27,1);
   h11->SetBinContent(28,1);
   h11->SetBinContent(29,1);
   h11->SetBinContent(32,1);
   h11->SetBinContent(34,2);
   h11->SetBinContent(35,1);
   h11->SetBinContent(38,1);
   h11->SetBinContent(39,1);
   h11->SetBinContent(42,2);
   h11->SetBinContent(43,3);
   h11->SetBinContent(45,1);
   h11->SetBinContent(46,1);
   h11->SetBinContent(47,1);
   h11->SetBinContent(48,3);
   h11->SetBinContent(51,13);
   h11->SetMinimum(0);
   h11->SetMaximum(33.97137);
   h11->SetEntries(219);
   h11->SetStats(0);
   h11->SetLineWidth(4);
   ...
   fmass12->SetParameter(0,0.4404504);
   fmass12->SetParError(0,0.1098863);
   fmass12->SetParLimits(0,0,0);
   fmass12->SetParameter(1,5.374086);
   fmass12->SetParError(1,0.005107924);
   fmass12->SetParLimits(1,0,0);
   fmass12->SetParameter(2,0.1);
   ...
   fmass12->SetParameter(7,0.06114868);
   fmass12->SetParError(7,0);
   fmass12->SetParLimits(7,0,0);
   fmass12->SetParameter(8,0.01723737);
   fmass12->SetParError(8,0);
   fmass12->SetParLimits(8,0,0);
   fmass12->Draw("same");
   
   TF1 *f13 = new TF1("f1","[0]*([7]*exp(-0.5*((x-[1])/[2])^2)/(sqrt(2*3.14159)*[2])+(1-[7])*exp(-0.5*((x-[1])/[8])^2)/(sqrt(2*3.14159)*[8]))+[3]+[4]*x+[5]*x*x+[6]*x*x*x",5,6);
   f13->SetNpx(5000);
   f13->SetFillColor(19);
   f13->SetFillStyle(0);
   f13->SetLineColor(2);
   f13->SetChisquare(53.40365);
   f13->SetNDF(44);
   ...
   f13->SetParameter(0,0.4404504);
   f13->SetParError(0,0.1098863);
   f13->SetParLimits(0,0,0);
   f13->SetParameter(1,5.374086);
   f13->SetParError(1,0.005107924);
   f13->SetParLimits(1,0,0);
   f13->SetParameter(2,0.1);
   f13->SetParError(2,0);
   f13->SetParLimits(2,0.1,0.1);
   f13->SetParameter(3,50.92195);
   f13->SetParError(3,6.846985);
   f13->SetParLimits(3,0,0);
   f13->SetParameter(4,-0.4184871);
   f13->SetParError(4,0.1965073);
   f13->SetParLimits(4,-0.7,-0.4);
   f13->SetParameter(5,-4.427572);
   f13->SetParError(5,0.2961664);
   f13->SetParLimits(5,0,0);
   f13->SetParameter(6,0.5191201);
   f13->SetParError(6,0.03728409);
   f13->SetParLimits(6,0,0);
   f13->SetParameter(7,0.06114868);
   f13->SetParError(7,0);
   f13->SetParLimits(7,0.06114868,0.06114868);
   f13->SetParameter(8,0.01723737);
   f13->SetParError(8,0);
   f13->SetParLimits(8,0.01723737,0.01723737);
   f13->Draw("same");
   
   TH1D *h1_copy2 = new TH1D("h1_copy2","",50,5,6);
   h1_copy2->SetBinContent(0,114);
   h1_copy2->SetBinContent(1,7);
   h1_copy2->SetBinContent(3,1);
   h1_copy2->SetBinContent(4,2);
   h1_copy2->SetBinContent(5,4);
   h1_copy2->SetBinContent(6,7);
   h1_copy2->SetBinContent(8,3);
   h1_copy2->SetBinContent(9,1);
   h1_copy2->SetBinContent(10,1);
   h1_copy2->SetBinContent(11,2);
   h1_copy2->SetBinContent(12,1);
   h1_copy2->SetBinContent(14,1);
   h1_copy2->SetBinContent(15,1);
   h1_copy2->SetBinContent(16,3);
   h1_copy2->SetBinContent(17,2);
   h1_copy2->SetBinContent(18,3);
   h1_copy2->SetBinContent(19,15);
   h1_copy2->SetBinContent(20,4);
   h1_copy2->SetBinContent(21,4);
   h1_copy2->SetBinContent(22,2);
   h1_copy2->SetBinContent(23,4);
   h1_copy2->SetBinContent(24,1);
   h1_copy2->SetBinContent(25,1);
   h1_copy2->SetBinContent(26,2);
   h1_copy2->SetBinContent(27,1);
   h1_copy2->SetBinContent(28,1);
   h1_copy2->SetBinContent(29,1);
   h1_copy2->SetBinContent(32,1);
   h1_copy2->SetBinContent(34,2);
   h1_copy2->SetBinContent(35,1);
   h1_copy2->SetBinContent(38,1);
   h1_copy2->SetBinContent(39,1);
   h1_copy2->SetBinContent(42,2);
   h1_copy2->SetBinContent(43,3);
   h1_copy2->SetBinContent(45,1);
   h1_copy2->SetBinContent(46,1);
   h1_copy2->SetBinContent(47,1);
   h1_copy2->SetBinContent(48,3);
   h1_copy2->SetBinContent(51,13);
   h1_copy2->SetMinimum(0);
   h1_copy2->SetMaximum(33.97137);
   h1_copy2->SetEntries(219);
   h1_copy2->SetDirectory(0);
   h1_copy2->SetStats(0);
   
   TF1 *f11 = new TF1("f1","[0]*([7]*exp(-0.5*((x-[1])/[2])^2)/(sqrt(2*3.14159)*[2])+(1-[7])*exp(-0.5*((x-[1])/[8])^2)/(sqrt(2*3.14159)*[8]))+[3]+[4]*x+[5]*x*x+[6]*x*x*x",5,6);
   f11->SetNpx(5000);
   f11->SetFillColor(19);
   f11->SetFillStyle(0);
   f11->SetLineColor(2);
   f11->SetChisquare(53.40365);
   f11->SetNDF(44);
   ...
   f11->SetParameter(0,0.4404504);
   f11->SetParError(0,0.1098863);
   f11->SetParLimits(0,0,0);
   f11->SetParameter(1,5.374086);
   f11->SetParError(1,0.005107924);
   f11->SetParLimits(1,0,0);
   f11->SetParameter(2,0.1);
   f11->SetParError(2,0);
   f11->SetParLimits(2,0.1,0.1);
   f11->SetParameter(3,50.92195);
   f11->SetParError(3,6.846985);
   f11->SetParLimits(3,0,0);
   f11->SetParameter(4,-0.4184871);
   f11->SetParError(4,0.1965073);
   f11->SetParLimits(4,-0.7,-0.4);
   f11->SetParameter(5,-4.427572);
   f11->SetParError(5,0.2961664);
   f11->SetParLimits(5,0,0);
   f11->SetParameter(6,0.5191201);
   f11->SetParError(6,0.03728409);
   f11->SetParLimits(6,0,0);
   f11->SetParameter(7,0.06114868);
   f11->SetParError(7,0);
   f11->SetParLimits(7,0.06114868,0.06114868);
   f11->SetParameter(8,0.01723737);
   f11->SetParError(8,0);
   f11->SetParLimits(8,0.01723737,0.01723737);
...
tex->SetNDC();
   ...
   f12->SetParameter(0,0.4404504);
   f12->SetParError(0,0.1098863);
   f12->SetParLimits(0,0,0);
   f12->SetParameter(1,5.374086);
   f12->SetParError(1,0.005107924);
   f12->SetParLimits(1,0,0);
   f12->SetParameter(2,0.1);
   f12->SetParError(2,0);
   f12->SetParLimits(2,0.1,0.1);
   f12->SetParameter(3,50.92195);
   f12->SetParError(3,6.846985);
   f12->SetParLimits(3,0,0);
   f12->SetParameter(4,-0.4184871);
   f12->SetParError(4,0.1965073);
   f12->SetParLimits(4,-0.7,-0.4);
   f12->SetParameter(5,-4.427572);
   f12->SetParError(5,0.2961664);
   f12->SetParLimits(5,0,0);
   f12->SetParameter(6,0.5191201);
   f12->SetParError(6,0.03728409);
   f12->SetParLimits(6,0,0);
   f12->SetParameter(7,0.06114868);
   f12->SetParError(7,0);
   f12->SetParLimits(7,0.06114868,0.06114868);
   f12->SetParameter(8,0.01723737);
   f12->SetParError(8,0);
   f12->SetParLimits(8,0.01723737,0.01723737);
   f12->Draw("same");
   
   TH1D *h13 = new TH1D("h13","",50,5,6);
   h13->SetBinContent(0,114);
   h13->SetBinContent(1,7);
   h13->SetBinContent(3,1);
   h13->SetBinContent(4,2);
   h13->SetBinContent(5,4);
   h13->SetBinContent(6,7);
   h13->SetBinContent(8,3);
   h13->SetBinContent(9,1);
   h13->SetBinContent(10,1);
   h13->SetBinContent(11,2);
   h13->SetBinContent(12,1);
   h13->SetBinContent(14,1);
   h13->SetBinContent(15,1);
   h13->SetBinContent(16,3);
   h13->SetBinContent(17,2);
   h13->SetBinContent(18,3);
   h13->SetBinContent(19,15);
   h13->SetBinContent(20,4);
   h13->SetBinContent(21,4);
   h13->SetBinContent(22,2);
   h13->SetBinContent(23,4);
   h13->SetBinContent(24,1);
   h13->SetBinContent(25,1);
   h13->SetBinContent(26,2);
   h13->SetBinContent(27,1);
   h13->SetBinContent(28,1);
   h13->SetBinContent(29,1);
   h13->SetBinContent(32,1);
   h13->SetBinContent(34,2);
   h13->SetBinContent(35,1);
   h13->SetBinContent(38,1);
   h13->SetBinContent(39,1);
   h13->SetBinContent(42,2);
   h13->SetBinContent(43,3);
   h13->SetBinContent(45,1);
   h13->SetBinContent(46,1);
   h13->SetBinContent(47,1);
   h13->SetBinContent(48,3);
   h13->SetBinContent(51,13);
   h13->SetMinimum(0);
   h13->SetMaximum(33.97137);
   h13->SetEntries(219);
   h13->SetStats(0);
   h13->SetLineWidth(4);
   ...
   h13->Draw("e same");
      tex = new TLatex(0.55,0.5,"#chi^{2}/nDOF: 66/44 = 1.5");
tex->SetNDC();
   tex->SetTextAlign(12);
   tex->SetTextFont(42);
   ...
   tex->SetLineWidth(2);
   tex->Draw();
      tex = new TLatex(0.55,0.54,"Significance = 4.1");
tex->SetNDC();
   tex->SetTextFont(42);
   tex->SetTextSize(0.04);
   tex->SetLineWidth(2);
   tex->Draw();
      tex = new TLatex(0.55,0.44,"Yield = 22");
tex->SetNDC();
   tex->SetTextFont(42);
   tex->SetTextSize(0.04);
   tex->SetLineWidth(2);
